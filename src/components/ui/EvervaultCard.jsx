...
export const EvervaultCard = ({
  ...
  return (
    <div
      className={cn(
        "p-0.5  bg-white aspect-square  flex items-center justify-center w-[100vw] h-[100vh] relative",
        className
      )}>
      <div
        ...
        <div className="relative z-10 flex items-center justify-center">
          <div
            className="relative h-[100vh] w-[100vw]  rounded-full flex items-center justify-center text-white font-bold text-9xl">
            <div
              className="" />
