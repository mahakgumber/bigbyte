      ...
      <div className="flex flex-col lg:flex-row w-full h-screen relative z-10 overflow-x-hidden overflow-y-auto">
        ...
        <div className="bg-white flex">
          <div className="globe bg-white">
            <div className="heading ml-4 md:ml-8 mt-16 md:mt-10 xs:mt-10 lg:ml-0 lg:mt-48">
        ...
        <div className="right_side_container bg-[#0a243a] w-full xs:h-[50%] xs:w-[100vw] xs:mt-0 h-[80vh] lg:h-[100vh] lg:w-[25vw]  relative mt-8 md:mt-5 lg:mt-0">
          ...
          <div className="absolute md:top-10 xs:top-6 top-10 left-1/2 xs:left-[10.5rem] transform -translate-x-1/2 md:left-[30px]  lg:w-[20vw] lg:mt-[140px] lg:left-[10px] s:left-60  md:translate-x-0 xl:w-[90%] xs:w-[94%]  md:w-[80vw]  xl:left-[-30px] xl:h-[50vh] xs:h-[40vh] md:h-[40vh] bg-white shadow-lg rounded-tr-[50px] md:rounded-tr-[50px] rounded-br-[50px] md:rounded-br-[50px] overflow-hidden ">
            <img
