  ...
  return (
    <>
      <div className='relative '>
        <img src="./images/Industries/Ecommerce/Ecommerce3.avif" alt="" className='w-[100vw] h-[100vh] xs:w-[100vw]'/>
        ...
        tab:top-[40%] tab:text-7xl transition-colors '>E-Commerce Development</div>
      </div>
    </>
  )
}
